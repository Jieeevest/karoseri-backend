...
CREATE TABLE public."BOM" (
    id integer NOT NULL,
    "karoseriCategoryId" integer NOT NULL,
    name text NOT NULL,
    description text,
    "createdAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    "updatedAt" timestamp(3) without time zone NOT NULL
...
--
-- Name: BOMItem_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."BOMItem_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."BOMItem_id_seq" OWNER TO postgres;

--
-- Name: BOMItem_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."BOMItem_id_seq" OWNED BY public."BOMItem".id;
...
--
-- Name: KaroseriCategory; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."KaroseriCategory" (
    id integer NOT NULL,
    name text NOT NULL,
    "createdAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    "updatedAt" timestamp(3) without time zone NOT NULL,
...
ALTER TABLE public."KaroseriCategory" OWNER TO postgres;

--
-- Name: KaroseriCategory_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."KaroseriCategory_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."KaroseriCategory_id_seq" OWNER TO postgres;

--
-- Name: KaroseriCategory_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."KaroseriCategory_id_seq" OWNED BY public."KaroseriCategory".id;
...
--
-- Name: ProjectBOMItem; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."ProjectBOMItem" (
    id integer NOT NULL,
...
ALTER TABLE public."ProjectBOMItem" OWNER TO postgres;

--
-- Name: ProjectBOMItem_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."ProjectBOMItem_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."ProjectBOMItem_id_seq" OWNER TO postgres;

--
-- Name: ProjectBOMItem_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."ProjectBOMItem_id_seq" OWNED BY public."ProjectBOMItem".id;
...
--
-- Name: BOMItem id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."BOMItem" ALTER COLUMN id SET DEFAULT nextval('public."BOMItem_id_seq"'::regclass);
...
--
-- Name: KaroseriCategory id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."KaroseriCategory" ALTER COLUMN id SET DEFAULT nextval('public."KaroseriCategory_id_seq"'::regclass);
...
--
-- Name: ProjectBOMItem id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ProjectBOMItem" ALTER COLUMN id SET DEFAULT nextval('public."ProjectBOMItem_id_seq"'::regclass);
...
COPY public."BOM" (id, "karoseriCategoryId", name, description, "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public."BOMItem" (id, "inventoryId", "quantityPerUnit", "createdAt", "updatedAt", "bomId") FROM stdin;
\.
...
COPY public."Inventory" (id, name, amount, "locationId", "minimumStock", description, "createdAt", "updatedAt", price, "supplierId", unit, "currentStock", jenis) FROM stdin;
2	AS BULAT 16 MM x 6 M - HITAM XX	100	1	10		2025-05-29 12:42:30.327	2025-05-29 13:05:45.838	10000	2	3	0	2
\.


--
-- Data for Name: KaroseriCategory; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."KaroseriCategory" (id, name, "createdAt", "updatedAt", description) FROM stdin;
1	Karoseri Wing Box (Tronton)	2025-05-29 11:12:48.618	2025-05-29 11:12:48.618	Deskripsi Karoseri Wing Box (Tronton)\n
\.
...
COPY public."Project" (id, name, "customerName", "karoseriCategoryId", "unitCount", status, "startDate", "endDate", "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: ProjectBOMItem; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."ProjectBOMItem" (id, "projectId", "inventoryId", quantity, "createdAt", "updatedAt") FROM stdin;
\.
...
1	Gudang X	Deskripsi Gudang X	2025-05-29 00:08:57.368	2025-05-29 03:30:48.035
2	Gudang Y	Deskripsi Gudang Y	2025-05-29 03:44:41.805	2025-05-29 03:44:41.805
\.
...
--
-- Name: BOMItem_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."BOMItem_id_seq"', 1, false);
...
--
-- Name: KaroseriCategory_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."KaroseriCategory_id_seq"', 1, true);
...
--
-- Name: ProjectBOMItem_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."ProjectBOMItem_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."SavingLocation_id_seq"', 3, true);
...
--
-- Name: KaroseriCategory KaroseriCategory_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."KaroseriCategory"
    ADD CONSTRAINT "KaroseriCategory_pkey" PRIMARY KEY (id);
...
--
-- Name: ProjectBOMItem ProjectBOMItem_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ProjectBOMItem"
    ADD CONSTRAINT "ProjectBOMItem_pkey" PRIMARY KEY (id);
...
--
-- Name: KaroseriCategory_name_key; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX "KaroseriCategory_name_key" ON public."KaroseriCategory" USING btree (name);
...
--
-- Name: BOMItem BOMItem_inventoryId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."BOMItem"
    ADD CONSTRAINT "BOMItem_inventoryId_fkey" FOREIGN KEY ("inventoryId") REFERENCES public."Inventory"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: BOM BOM_karoseriCategoryId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."BOM"
    ADD CONSTRAINT "BOM_karoseriCategoryId_fkey" FOREIGN KEY ("karoseriCategoryId") REFERENCES public."KaroseriCategory"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE ONLY public."Inventory"
    ADD CONSTRAINT "Inventory_supplierId_fkey" FOREIGN KEY ("supplierId") REFERENCES public."Supplier"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
--
-- Name: ProjectBOMItem ProjectBOMItem_inventoryId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ProjectBOMItem"
    ADD CONSTRAINT "ProjectBOMItem_inventoryId_fkey" FOREIGN KEY ("inventoryId") REFERENCES public."Inventory"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: ProjectBOMItem ProjectBOMItem_projectId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ProjectBOMItem"
    ADD CONSTRAINT "ProjectBOMItem_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES public."Project"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: Project Project_karoseriCategoryId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Project"
    ADD CONSTRAINT "Project_karoseriCategoryId_fkey" FOREIGN KEY ("karoseriCategoryId") REFERENCES public."KaroseriCategory"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
